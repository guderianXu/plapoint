...
inline const std::vector<int>& triTable(int cubeIndex)
{
    static const std::vector<int> table[256] = {
        ...
        {}, // 189
        {6,9,11,9,6,8,3,10,11,1,10,3}, // 190
        {}, // 191
        {5,10,6,7,11,4}, // 192
        {4,3,0,7,3,4,6,5,10}, // 193
        {0,1,9,4,7,8,5,10,6}, // 194
        {10,6,5,9,4,1,7,3,4,9,1,7}, // 195
        {1,2,10,5,10,6,4,7,8}, // 196
        {3,4,0,7,3,4,1,2,10,5,10,6}, // 197
        {8,4,7,9,0,2,9,2,5,2,10,5}, // 198
        {5,10,2,6,5,2,7,3,4,9,8,4}, // 199
        {8,4,7,2,3,11,9,5,4}, // 200
        {0,11,2,0,8,11,4,9,5,9,4,5}, // 201
        {4,5,9,0,1,8,8,3,0,2,3,11}, // 202
        {5,4,11,5,11,2,4,9,11,1,11,9,9,8,11}, // 203
        {10,1,3,10,3,11,5,4,9}, // 204
        {0,9,4,5,10,1,8,11,10,0,11,8}, // 205
        {3,8,0,9,5,4,10,6,11}, // 206
        {4,5,9,6,10,11,8,3,10,8,10,11}, // 207
        {4,9,5,7,6,11}, // 208
        {3,0,8,7,6,11,5,4,9}, // 209
        {0,1,9,5,4,7,6,11,7}, // 210
        {8,1,9,8,3,1,11,7,6,5,4,7}, // 211
        {1,2,10,6,11,7,4,9,5}, // 212
        {3,0,8,1,2,10,6,11,7,5,4,9}, // 213
        {9,2,10,9,0,2,7,6,11,4,9,5}, // 214
        {2,10,8,2,8,3,10,9,8,5,4,7,6,11,7}, // 215
        {11,3,2,7,6,11,10,1,2}, // 216
        {0,11,2,0,8,11,10,1,2,7,6,11}, // 217
        {0,1,9,3,2,11,6,7,11}, // 218
        {9,8,1,1,8,2,2,8,3,6,7,11}, // 219
        {1,11,3,10,1,3,6,11,7}, // 220
        {0,8,11,1,0,11,3,11,10,1,10,3,7,6,11}, // 221
        {0,3,7,0,7,6,0,6,9,10,3,7}, // 222
        {6,8,10,7,6,10,9,8,10}, // 223
        {4,10,6,8,4,6,7,8,6}, // 224
        {0,4,10,0,10,6,0,6,3,4,7,10}, // 225
        {9,0,1,4,10,6,8,4,6,7,8,6}, // 226
        {9,4,1,1,4,3,3,4,6,3,6,7,10,6,3}, // 227
        {1,2,10,8,6,4,7,8,4}, // 228
        {1,2,10,3,0,4,3,4,7,3,7,6,10,6,7}, // 229
        {2,10,0,0,10,8,8,10,4,8,4,7}, // 230
        {2,10,3,3,10,7,7,10,4,7,4,9}, // 231
        {11,2,3,4,10,6,8,4,6,7,8,6}, // 232
        {0,11,2,0,8,11,6,4,10,4,6,8}, // 233
        {1,9,0,2,3,11,6,4,10,8,4,6}, // 234
        {9,4,6,1,11,2,8,4,9,11,9,2}, // 235
        {10,1,3,10,3,11,4,8,6,7,8,4}, // 236
        {1,0,11,1,11,3,1,3,10,4,7,11,0,4,11,7,6,4}, // 237
        {9,5,4,10,1,2}, // 238
        {9,5,4,0,8,3,1,2,10}, // 239
        {0,5,4,1,5,0,2,10,1,6,10,2}, // 240
        {8,5,4,8,3,5,3,1,5,6,10,2,10,1,2}, // 241
        {1,4,9,2,6,1,4,6,9}, // 242
        {2,6,1,0,8,3,9,5,4}, // 243
        {0,2,9,9,2,4,4,2,6,5,4,6}, // 244
        {8,3,2,8,2,4,4,2,6,5,4,6,9,8,4}, // 245
        {10,4,9,6,4,10,3,11,2}, // 246
        {0,8,2,2,8,11,9,10,4,10,9,4}, // 247
        {3,11,2,0,1,6,0,6,4,6,1,10,4,9,10}, // 248
        {6,4,1,6,1,10,4,8,1,2,1,11,8,11,1}, // 249
        {9,6,4,9,3,6,9,1,3,11,6,3}, // 250
        {8,11,1,8,1,0,11,6,1,9,1,4,6,4,1}, // 251
        {3,11,6,3,6,0,0,6,4}, // 252
        {6,4,8,11,6,8}, // 253
        {}, // 254
        {}, // 255
    };
